...
namespace ChatServidor
{
    ...
    class ChatServidor
    {
        ...
        public static void EnviaMensagemAdmin(string Mensagem)
        {
            ...
            e = new StatusChangedEventArgs("Servidor: " + Mensagem); // Alterado para "Servidor"
            OnStatusChanged(e);
            ...
            for (int i = 0; i < tcpClientes.Length; i++)
            {
                ...
                try
                {
                    ...
                    swSenderSender.WriteLine("Servidor: " + Mensagem); // Alterado para "Servidor"
        ...
        public void FinalizarServidor()
        {
            ...
            EnviaMensagemAdmin("Servidor finalizado pelo administrador.");
        }
    }
